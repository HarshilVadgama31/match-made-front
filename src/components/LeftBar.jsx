  ...
  return (
    <>
      <div className="hidden md:flex md:h-full">
        <div className="flex flex-col relative place-content-between h-full w-full rounded-br-xl rounded-tr-xl bg-card_light py-4 dark:bg-card_dark">
          <div className="h-60 flex flex-col place-content-around items-center z-10">
            <button
              onClick={() => {
                setSelectedOption(1);
              }}
          ...
          <div
            className={` ${pickAt} h-20 w-5/6 bg-button_light rounded-br-xl rounded-tr-xl justify-start absolute dark:bg-button_dark`}
          ></div>
