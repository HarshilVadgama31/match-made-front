...
function InputChip({ id, onChangeValue, list, keyType }) {
  ...
  return (
    ...
    <div className="ml-1 w-full">
      ...
      >
        { 
        ((Array.isArray(chips) && !chips.length ) || (chips==undefined)) ? "Select" : (
      ...
      <DialogBox id={id} passedOpen={[handleOpen,open]} li={list} keyType={keyType} chipArray={setChips} />
    </div>
  );
}
