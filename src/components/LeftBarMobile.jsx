...
function LeftBarMobile({ activeAt }) {
  ...
  return (
    <>
      <div className="fixed mx-auto bottom-0 left-0 right-0 p-2 ${pickAt} h-[5rem]">
        
          <div className="flex flex-wrap h-full w-full items-center justify-center gap-8 z-10 overflow-scroll rounded-xl bg-card_light py-4 dark:bg-card_dark">
            <button
              onClick={() => {
                setSelectedOption(1);
              }}
            >
              <Link to="/matchfeed">
                <svg
                  ...
                  height="35"
                  viewBox="0 0 24 24"
                  className="rounded-md focus:bg-button_light active:bg-button_light dark:focus:bg-button_dark dark:active:bg-button_dark p-1 fill-bg_dark dark:fill-bg_light"
                >
